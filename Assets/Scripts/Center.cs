...
public class Center : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (targetType == 1 && GameObject.FindWithTag("Melee") != null)
        {
        ...
        else if (targetType == 2 && GameObject.FindWithTag("Sniper") != null)
        {
        ...
        else if (targetType == 3 && GameObject.FindWithTag("Support") != null)
        {
        ...
        else if (targetType == 4 && GameObject.FindWithTag("Heavy")!= null)
        {
